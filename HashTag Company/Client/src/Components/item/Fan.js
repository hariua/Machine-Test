    ...
    return (
        <div>
            <Container>
                ...
                <Typography variant="h4" className="text-white">Create Your Fan Account</Typography>
                <Form>
                    ...
                    <Grid container alignItems="center" direction="column">
                    <Grid item >
                    <input type="checkbox" className="input text-success mt-5"></input><span className="text-white pl-2">I agree to the <span style={{cursor:"pointer"}} className="text-success">Terms and Conditions</span></span><br></br>
                    </Grid>
